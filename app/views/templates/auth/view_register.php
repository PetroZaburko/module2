...
$this->layout('view_auth_head', ['title' => $title]) ;
?>
                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <form id="js-login" novalidate="" action="register" method="post">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="username">Имя пользователя <br></label>
                                            <input type="tex" name="username" id="username" class="form-control" placeholder="" required>
                                            <div class="invalid-feedback">Заполните поле.</div>
                                        </div>
